 ...
 **********************************************************************/
//
//  DecodeHe3TRawDataV02.cc
//  
//
//  Created by Haolai TIAN 1th Dec. 2017.
//
//
...
DecodeHe3TRawDataV02::DecodeHe3TRawDataV02()
...
void DecodeHe3TRawDataV02::U8to2U4(uint32_t *Input, uint32_t *Output_1, uint32_t *Output_2){
	*Output_1 = (((((uint32_t)(*Input))&0xFF)>>4)&0xF);
	*Output_2 =   (((uint32_t)(*Input))&0xF);
};

void DecodeHe3TRawDataV02::U32toU12U20(uint32_t *Input, uint32_t *Output_1, uint32_t *Output_2){
	*Output_1 = ((((uint32_t)(*Input))>>20)&0xFFF);
	*Output_2 =  (((uint32_t)(*Input))&0xFFFFF);
};

//====================
void DecodeHe3TRawDataV02::U32_1st(uint8_t *Input, uint32_t *Output){
	*Output = (((((uint32_t)(*Input))&0xFF)<<24)&0xFF000000);
};

void DecodeHe3TRawDataV02::U32_2ed(uint8_t *Input, uint32_t *Output){
	*Output |= (((((uint32_t)(*Input)&0xFF))<<16)&0xFF0000);
};

void DecodeHe3TRawDataV02::U32_3rd(uint8_t *Input, uint32_t *Output){
	*Output |= (((((uint32_t)(*Input)&0xFF))<<8)&0xFF00);
};

void DecodeHe3TRawDataV02::U32_4th(uint8_t *Input, uint32_t *Output){
	*Output |= ((((uint32_t)(*Input)&0xFF))&0xFF);
};

//====================
void DecodeHe3TRawDataV02::Decode_PulseHdr00(uint8_t *Input){
	if(0xFA == *Input) m_status = PulseHdr00;
	else m_status = PExecReady;
};

uint32_t DecodeHe3TRawDataV02::Decode_PulseHit00(uint8_t *Input){
	m_return = 0x0;
...
void DecodeHe3TRawDataV02::Decode_PulseEnd00(uint8_t *Input){
	if(0xFB == *Input)m_status = PulseEnd00;
	else m_status = PExecError;
...
uint32_t DecodeHe3TRawDataV02::Decode_RawDataSegment(uint8_t *ReadRawData){
	//printf("%x\n", *ReadRawData);
